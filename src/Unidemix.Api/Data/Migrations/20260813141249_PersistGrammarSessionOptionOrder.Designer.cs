...
namespace Unidemix.Api.Data.Migrations
{
    ...
    [Migration("20260813141249_PersistGrammarSessionOptionOrder")]
    partial class PersistGrammarSessionOptionOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Unidemix.Api.Models.ExamProvider", b =>
                {
                    ...
                    b.HasIndex("LanguageCode", "Code")
                        .IsUnique();

                    b.ToTable("ExamProviders");
                });

            modelBuilder.Entity("Unidemix.Api.Models.ExamSection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Unidemix.Api.Models.Exercise", b =>
                {
                    ...
                    b.Property<bool>("IsQuestionBankItem")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("QuestionSkill")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Unidemix.Api.Models.Lesson", b =>
                {
                    ...
                    b.Property<int?>("AudioScriptExerciseOrder")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("CanDoObjectivesJson")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("DeferredGrammarJson")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Unidemix.Api.Models.VocabularyItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Unidemix.Api.Models.VocabularyReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Unidemix.Api.Models.VocabularyReview", b =>
                {
                    ...
                    b.HasOne("Unidemix.Api.Models.VocabularyItem", "VocabularyItem")
                        .WithMany("Reviews")
